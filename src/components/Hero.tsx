  ...
  return (
    <section className="w-full py-12 md:py-24">
      <div className="flex flex-col items-center">
        <h1 className="sm:leading-normal text-5xl text-center font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-green-500">
