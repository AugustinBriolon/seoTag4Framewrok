...
export default function App() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center px-8 py-4 gap-12">
      ...
      <div className="flex flex-col gap-8 h-full w-full">
        ...
        <div className="flex flex-col md:flex-row gap-8 h-fit w-full">
          <div className="w-full md:w-1/2 max-h-full flex flex-col gap-4">
            ...
            <Input id="urlTag" label="URL" imageScr="/icons/url.svg" placeholder="https://www.example.com" type="text" value={ogMetaTags.url} onChange={(e) => setOgMetaTags({ ...ogMetaTags, url: e.target.value })} />
            <Input id="imageTag" label="Image" imageScr="/icons/image.svg" placeholder="https://www.example.com/ogimage.webp (1200px x 630px)" type="text" value={ogMetaTags.image} onChange={(e) => setOgMetaTags({ ...ogMetaTags, image: e.target.value })} />
            ...
            <Input id="authorTag" label="Author" imageScr="/icons/author.svg" placeholder="John Doe" type="text" value={ogMetaTags.author} onChange={(e) => setOgMetaTags({ ...ogMetaTags, author: e.target.value })} />
          </div>
